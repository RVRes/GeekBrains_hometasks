...
function translit($string) {
    ...
    return strtr($string, $convertArray);
}
...
function convertToLink($string) {
	return preg_replace('[ ]', '_', translit($string));
}

echo convertToLink("9. *Объединить две ранее написанные функции в одну, которая получает строку
на русском языке, производит транслитерацию и замену пробелов на подчеркивания (аналогичная задача
